...
const unsigned int SENERY_TEXTURE_PATH_SIZE = 4;
...
const std::string RESOURCES_SENERY_TEXTURE_PATH[SENERY_TEXTURE_PATH_SIZE] = { "texture1" , "texture2" , "texture3" , "texture4"};
